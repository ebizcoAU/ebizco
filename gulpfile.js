...
// Paths to project folders
 ...
 const paths = {
  ...
  dist:{
    ...
    certs: './dist/certs',
    assets: './dist/assets',
    layerslider:'./dist/layerslider'

    }
}

// layerslider
function layerslider(callback) {
  return src(paths.src.layerslider)
      .pipe(dest(paths.dist.layerslider));
    callback();
}
...
function jsfiles(callback) {
  return src([paths.src.js, '!src/assets/js/**/*.min.js'])
//        .pipe(minify())
...
function cssfiles(callback) {
  return src([paths.src.css,paths.src.cssmap])
...
function watchTask(){
    ...
    watch([paths.src.images, paths.src.fonts, paths.src.css], series(images, fonts, cssfiles));
...
exports.default = series(parallel(cleanDist), certs, serverjs, jsfilesDEV, cssfiles, layerslider, vendor, html, images, audio, fonts, copyLibs, watchTask);

exports.preview = series( fileincludeTask, browsersyncServe, watchTaskWithBrowserSync);

// Build Task for Dist
exports.build = series(parallel(cleanDist), certs, serverjs, jsfiles, cssfiles, layerslider,  jsmap, jsmin, vendor, cleanNonMinifyJS, html, images,  audio,  fonts, copyLibs, cleanTemp);
